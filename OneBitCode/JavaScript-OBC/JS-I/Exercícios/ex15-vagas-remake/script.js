...
function inscreverCandidato() {
    ...
    const confirmacao = confirm('Deseja inscrever o candidado ' + candidato + ' na vaga ' + indice + '?\n' + 
    'Nome: ' + vaga.nome + '\nDescrição: ' + vaga.descricao + '\nData limite: ' + vaga.dataLimite)
...
function excluirVaga(){
    const indice = prompt('Informe o índice da vaga para excluir')
    const vaga = vagas[indice]

    const confirmacao = confirm(
        'Tem certeza que deseja excluir a vaga ' + vaga + '?'
    )
